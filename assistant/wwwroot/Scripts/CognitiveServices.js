        ...
        this.Create = function (config, authInfo, connectionId) {
            ...
            switch (config.RecognitionMode) {
                ...
                default:
                    ...
                    endpoint="wss://eastasia.stt.speech.microsoft.com/speech/recognition/conversation/cognitiveservices/v1";
                    break;
            }
            var queryParams = {
...
var CognitiveServicesHelper = (function () {
    ...
    function CognitiveServicesHelper(props) {
        var _this = this;
        // tslint:disable:variable-name
        this._tokenURL = 'https://eastasia.api.cognitive.microsoft.com/sts/v1.0/issuetoken';
